"""
Duration Efficiency Models and Configuration.

This module contains data models and configuration for duration efficiency
...
class OperatorBenchmark:
    ...
    Attributes:
        machine_id: Machine identifier
        process_type: Tooling type classification
        vendor_name: Supplier name for context
...
def get_default_config() -> Dict:
    """Get default configuration parameters for duration efficiency analysis.
