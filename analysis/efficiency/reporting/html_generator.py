"""
Duration Efficiency HTML Report Generator.

This module generates comprehensive HTML reports for duration efficiency and
...
def generate_html_report(
    ...
    title: str = "Duration Efficiency & Supplier Benchmarking Report",
) -> str:
    """Generate a comprehensive HTML report for duration efficiency analysis.
    ...
    for benchmark in supplier_benchmarks:
        ...
        html += f"""
                <tr>
                    ...
                    <td><strong>{benchmark.vendor_name}</strong></td>
