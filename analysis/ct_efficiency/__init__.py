"""
Cycle Time Efficiency Analysis Module
======================================

Enhanced cycle time efficiency analysis with comprehensive supplier benchmarking.
...
Usage:
    ...
    result = run_analysis_api(
        ...
        end_date="2025-10-27",
        supplier_names=["Vantis industries SCS"],
        save_csv=True,
        save_html=True
    )
