"""
Duration Deviation Analysis Module
=====================================

Comprehensive duration deviation metrics for injection molding operations.

This module analyzes duration deviations from approved specifications,
providing insights into process stability and efficiency.

Features:
    - Snowflake database integration for shot-level data
    - duration deviation categorization (Excellent to Critical)
...
Deviation Categories:
    - Excellent: ≤5% deviation from approved duration
    - Good: 5-10% deviation
