"""
Duration Deviation HTML Report Generator.

This module generates comprehensive HTML reports for duration deviation analysis.
...
def generate_html_report(
    ...
    title: str = "Duration Deviation Analysis Report",
) -> str:
    """Generate a comprehensive HTML report for duration deviation analysis.
