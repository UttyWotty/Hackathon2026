"""
Duration Deviation Models and Configuration.

This module contains data models and configuration for duration deviation analysis.
...
class DeviationCategory(Enum):
    """Categories for duration deviations based on percentage from target."""
...
class DeviationMetrics:
    ...
    Attributes:
        ...
        target_duration: Approved/target duration
        deviation: Absolute deviation from approved duration
        deviation_percentage: Deviation as percentage of approved duration
...
def calculate_stability_score(std_dev: float, mean_duration: float) -> float:
